...
public class DashboardUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.addNoteBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DashboardUserActivity.this, UserAddActivity.class));
            }
        });
    }
    ...
    private void loadNotes() {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapterUserAdd = new AdapterUserAdd(DashboardUserActivity.this, noteAddArrayList);
