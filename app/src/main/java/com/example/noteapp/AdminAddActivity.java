...
import com.example.noteapp.databinding.ActivityAdminAddBinding;
        ...
        ref.child(""+timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(AdminAddActivity.this, "Your note added successfully...", Toast.LENGTH_SHORT).show();
                    }
                })
